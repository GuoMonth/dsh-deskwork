...
M1 alpha.2 已交付并获用户本地使用反馈；[M2 开发计划](specs/m2-dsh-plugins.md)已对齐 DSH 插件路线，待实施。M1 入口：[规格](specs/m1-configurable-workspace.md)、[视觉与交互](design/visual-system.md)、[预览使用与限制](preview.md)、[本轮验证](experiments/2026-09-06-configurable-mvp.md)、[范围决策](decisions/0005-configurable-workspace-scope.md)、[执行计划](roadmap.md)。
